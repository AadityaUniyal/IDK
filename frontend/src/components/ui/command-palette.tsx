            ...
            filtered.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center justify-between rounded-xl px-3 py-2.5 transition ${activeIndex === filtered.indexOf(item) ? "bg-slate-800/80" : "hover:bg-slate-800/60"}`}
                  aria-current={activeIndex === filtered.indexOf(item) ? "true" : undefined}
                >
